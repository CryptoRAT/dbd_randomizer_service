...
urlpatterns = [
    re_path(r'^survivor/random$', perk_views.RandomSurvivorPerkView.as_view({'get': 'random'}),  name='random-survivor-perks'),
    re_path(r'^killer/random$', perk_views.RandomKillerPerkView.as_view({'get': 'random'}), name='random-killer-perks'),
